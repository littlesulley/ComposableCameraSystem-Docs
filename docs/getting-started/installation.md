...
| Requirement | Notes |
|---|---|
| Unreal Engine **5.6** | The plugin tracks 5.6 and has not been back-ported. |
...
| Git (optional) | If you plan to track the plugin as a submodule. |
...
- `EnhancedInput` — the default UE 5.6 input system.
