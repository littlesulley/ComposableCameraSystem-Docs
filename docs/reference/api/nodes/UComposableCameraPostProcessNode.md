...
|--------|------|-------------|
| `FPostProcessSettings` | [`PostProcessSettings`](#postprocesssettings)  | Post-process settings to apply. Toggle individual `bOverride_*` flags to control which properties this node contributes. |
